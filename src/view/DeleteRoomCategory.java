...
public class DeleteRoomCategory extends JDialog implements ActionListener {
    JTable table;
    JButton delete = new JButton("delete");
    DefaultTableModel tableModel = new DefaultTableModel();

    public DeleteRoomCategory(Manager manager) {
        super(manager, "Delete Room Category", true);
